...
namespace ERPG
{
    [SearchTerm("Slime", "SlimeQueen")]
    public class SlimeQueen : Monster
    {
        public SlimeQueen(MonsterInventory inventoryRegister) : base(inventoryRegister)
        {
        }
    ...
    [SearchTerm("Slime", "SlimeQueenDrop")]
    public class SlimeQueenDrop : MonsterInventory
    {
